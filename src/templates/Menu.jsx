                ...
                <ul className="nav">
                    ...
                    <li className="nav-item">
                        ...
                        <div className="dropdown-menu-custom d-flex gap-2 px-2">
                            <Link className="badge text-decoration-none" to="/levels/N5">N5</Link>
                            <Link className="badge text-decoration-none" to="/levels/N4">N4</Link>
                            <Link className="badge text-decoration-none" to="/levels/N3">N3</Link>
                            <Link className="badge text-decoration-none" to="/levels/N2">N2</Link>
                            <Link className="badge text-decoration-none" to="/levels/N1">N1</Link>
                        </div>
                    </li>
                    <li className="nav-item">
