        ...
        <div className="col-md-3">
            <div className="card shadow-sm mb-4">
                ...
                <div className="card-body">
                    <h6 className="card-title text-success font-weight-bold">Học Bảng Chữ Cái</h6>
                    <p className="card-text text-muted" style={{ fontSize: "14px" }}>
                        Hãy liên tưởng hình ảnh để nhớ chữ Hiragana/Katakana nhanh hơn. Luyện viết 15 phút mỗi ngày!
                    </p>
                    <hr />
                    <h6 className="card-title text-success font-weight-bold">Bí quyết Kanji N5-N1</h6>
                    <p className="card-text text-muted" style={{ fontSize: "14px" }}>
                        Không học vẹt nét chữ, hãy học theo Bộ Thủ và ghép từ vựng thực tế để tăng phản xạ ghi nhớ.
                    </p>
                    <hr />
                    <h6 className="card-title text-success font-weight-bold">Luyện đề JLPT</h6>
                    <p className="card-text text-muted" style={{ fontSize: "14px" }}>
